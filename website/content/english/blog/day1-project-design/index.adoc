...
description: "Designing the project — the building blocks carried over from Mesh, and the decision to hand-write the schema and the spec rather than generate them from code."

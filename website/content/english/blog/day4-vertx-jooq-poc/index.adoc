...
description: "A reactive database layer proof of concept — why jOOQ over the alternatives, and what the reactive route costs when transactions are involved."
...
image:meme.gif[Ryan Gosling leaning out of a car window looking baffled, captioned "What do you want?"]

...
description: "The Loom Maven coordinates: the BOM that aligns versions, the client modules and the shared model."
---
...
The `metaloom` CLI is normally used as a binary rather than as a dependency — see
link:../../cli/[Command Line]. The module is published for embedding it in another tool:

...
The `cortex-custom-cli` example demonstrates how to build a Cortex CLI with a custom node added to the processing pipeline.
See the link:../../cortex/examples[Cortex Examples] page for details.

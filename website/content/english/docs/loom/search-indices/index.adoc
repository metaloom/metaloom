...
description: "The indices behind search, face matching and duplicate detection — what each one holds, when to rebuild it, and what a rebuild costs."
---
...
TIP: To see the duplicate index working on the demo container, start it with

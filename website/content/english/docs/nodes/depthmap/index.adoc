---
title: Depth Map
description: "Recovers how far away everything in a photo is, from the photo alone."
---
...
image::debug.png[The depthmap node after a run, showing the depth map it produced and the metadata describing it,role=img-fluid]
...
image::debug-detail.png[The depth map opened from the card - a 16-bit grayscale estimate of the portrait,role=ml-panel-shot]

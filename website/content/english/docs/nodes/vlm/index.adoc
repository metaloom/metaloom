---
title: VLM
description: "Reads a picture with a vision model — including document pages, as clean markdown."
---
...
image::debug.png[The VLM node after a run, with the page transcription it emitted,role=img-fluid]

The port is named after the prompt: configure two prompts and you get two ports. This run went to a
locally served Qwen2.5-VL; the page it read is German, and nothing in the prompt said so.

...
++++
<div class="ml-nodeviz" data-nodeviz='{"kind":"ocr","applies":"Image","badge":"Tesseract / tessdata","persist":"asset_json_comp + asset_node_result ledger","inputs":[{"t":"image","l":"image or scan"}],"outputs":[{"t":"text","l":"ocr_text","d":"recognised glyphs"}]}'></div>
++++

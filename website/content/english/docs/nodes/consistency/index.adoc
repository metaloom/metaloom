...
++++
<div class="ml-nodeviz" data-nodeviz='{"kind":"consistency","applies":"Video \u00b7 Audio","badge":"CPU only","persist":"asset consistency block + asset_node_result ledger","inputs":[{"t":"file","l":"media file","d":"scanned for zero chunks"}],"outputs":[{"t":"number","l":"zero_chunk_count"},{"t":"boolean","l":"is_complete","d":"read by downstream nodes"}]}'></div>
++++

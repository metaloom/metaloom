...
Once the container is running, Loom — and its embedded web UI — are available at http://localhost:8092.
...
Open http://localhost:8092 after starting the demo container. The first thing you land on is the

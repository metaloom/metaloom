...
description: "Run a complete MetaLoom stack locally in a few minutes with the demo container — no build tools, no configuration files, and real content on every screen from the first click."
weight: 1
---
	...
	<div class="col-lg-12 mb-4">
		<div class="docs-card h-100">
			<div class="docs-card-header">
				<h2 data-toc-skip><code>http://localhost:8092/ui/</code></h2>
...
Plain `\http://localhost:8092` redirects to `/ui/`, and every screen has its own address — bookmark
`\http://localhost:8092/ui/assets` or `\http://localhost:8092/ui/pipelines` and it will open there.

...
public class DaoCollectionImpl implements DaoCollection {
	...
	public DaoCollectionImpl(Lazy<UserDao> userDao, Lazy<PermissionDao> permissionDao,
		...
		Lazy<ChatSessionDao> chatSessionDao,
	...
	@Override
	public SkillVersionDao skillVersionDao() {
		return skillVersionDao.get();
	}

	@Override
	public ChatSessionDao chatSessionDao() {
		return chatSessionDao.get();
	}

	@Override
	public CortexInstanceDao cortexInstanceDao() {
		return cortexInstanceDao.get();
	}

	@Override
	public LoomDao loomDao() {
		return loomDao.get();
	}
}

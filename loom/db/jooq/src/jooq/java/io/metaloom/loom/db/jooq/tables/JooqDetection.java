...
public class JooqDetection extends TableImpl<JooqDetectionRecord> {
     ...
     */
    public final TableField<JooqDetectionRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

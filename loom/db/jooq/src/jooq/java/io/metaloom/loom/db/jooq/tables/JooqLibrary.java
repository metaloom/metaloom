...
public class JooqLibrary extends TableImpl<JooqLibraryRecord> {
     ...
     */
    public final TableField<JooqLibraryRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

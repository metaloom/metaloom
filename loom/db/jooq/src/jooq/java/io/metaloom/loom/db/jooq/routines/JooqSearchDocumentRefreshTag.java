...
public class JooqSearchDocumentRefreshTag extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.search_document_refresh_tag.p_uuid</code>.
     */
     ...
     */
    public JooqSearchDocumentRefreshTag() {
        super("search_document_refresh_tag", JooqPublic.PUBLIC);

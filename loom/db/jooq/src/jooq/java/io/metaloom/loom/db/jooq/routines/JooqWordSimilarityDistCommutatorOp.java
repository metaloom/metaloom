...
public class JooqWordSimilarityDistCommutatorOp extends AbstractRoutine<Float> {
     ...
     */
    public JooqWordSimilarityDistCommutatorOp() {
        super("word_similarity_dist_commutator_op", JooqPublic.PUBLIC, SQLDataType.REAL);

...
public class JooqStrictWordSimilarityDistCommutatorOp extends AbstractRoutine<Float> {
     ...
     */
    public JooqStrictWordSimilarityDistCommutatorOp() {
        super("strict_word_similarity_dist_commutator_op", JooqPublic.PUBLIC, SQLDataType.REAL);

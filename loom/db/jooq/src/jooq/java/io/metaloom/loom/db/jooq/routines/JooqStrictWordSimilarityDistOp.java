...
public class JooqStrictWordSimilarityDistOp extends AbstractRoutine<Float> {
     ...
     */
    public JooqStrictWordSimilarityDistOp() {
        super("strict_word_similarity_dist_op", JooqPublic.PUBLIC, SQLDataType.REAL);

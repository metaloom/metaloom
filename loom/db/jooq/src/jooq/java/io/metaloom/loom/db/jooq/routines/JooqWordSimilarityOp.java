...
public class JooqWordSimilarityOp extends AbstractRoutine<Boolean> {
     ...
     */
    public JooqWordSimilarityOp() {
        super("word_similarity_op", JooqPublic.PUBLIC, SQLDataType.BOOLEAN);

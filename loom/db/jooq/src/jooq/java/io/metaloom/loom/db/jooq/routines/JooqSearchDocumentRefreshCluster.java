...
public class JooqSearchDocumentRefreshCluster extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.search_document_refresh_cluster.p_uuid</code>.
     */
     ...
     */
    public JooqSearchDocumentRefreshCluster() {
        super("search_document_refresh_cluster", JooqPublic.PUBLIC);

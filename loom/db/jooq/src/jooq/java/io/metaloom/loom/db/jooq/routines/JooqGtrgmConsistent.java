...
public class JooqGtrgmConsistent extends AbstractRoutine<Boolean> {
     ...
     */
    public JooqGtrgmConsistent() {
        super("gtrgm_consistent", JooqPublic.PUBLIC, SQLDataType.BOOLEAN);

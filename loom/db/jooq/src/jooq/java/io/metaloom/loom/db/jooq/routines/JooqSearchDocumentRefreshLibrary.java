...
public class JooqSearchDocumentRefreshLibrary extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.search_document_refresh_library.p_uuid</code>.
     */
     ...
     */
    public JooqSearchDocumentRefreshLibrary() {
        super("search_document_refresh_library", JooqPublic.PUBLIC);

...
public class JooqStrictWordSimilarity extends AbstractRoutine<Float> {
     ...
     */
    public JooqStrictWordSimilarity() {
        super("strict_word_similarity", JooqPublic.PUBLIC, SQLDataType.REAL);

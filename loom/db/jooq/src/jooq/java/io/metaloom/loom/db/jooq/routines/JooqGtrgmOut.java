...
public class JooqGtrgmOut extends AbstractRoutine<Object> {
     ...
     */
    public JooqGtrgmOut() {
        super("gtrgm_out", JooqPublic.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"cstring\""));

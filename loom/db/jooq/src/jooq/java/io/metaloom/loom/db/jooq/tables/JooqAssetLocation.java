...
public class JooqAssetLocation extends TableImpl<JooqAssetLocationRecord> {
     ...
     */
    public final TableField<JooqAssetLocationRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

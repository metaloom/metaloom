...
public class JooqGinTrgmConsistent extends AbstractRoutine<Boolean> {
     ...
     */
    public JooqGinTrgmConsistent() {
        super("gin_trgm_consistent", JooqPublic.PUBLIC, SQLDataType.BOOLEAN);

...
public class JooqAssetVideoComp extends TableImpl<JooqAssetVideoCompRecord> {
     ...
     */
    public final TableField<JooqAssetVideoCompRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

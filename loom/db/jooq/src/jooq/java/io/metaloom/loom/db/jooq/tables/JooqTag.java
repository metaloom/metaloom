...
public class JooqTag extends TableImpl<JooqTagRecord> {
     ...
     */
    public final TableField<JooqTagRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

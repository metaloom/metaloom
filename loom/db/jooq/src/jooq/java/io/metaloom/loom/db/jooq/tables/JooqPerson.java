...
public class JooqPerson extends TableImpl<JooqPersonRecord> {
     ...
     */
    public final TableField<JooqPersonRecord, java.util.UUID> UUID = createField(DSL.name("uuid"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field("uuidv7()", SQLDataType.UUID)), this, "");

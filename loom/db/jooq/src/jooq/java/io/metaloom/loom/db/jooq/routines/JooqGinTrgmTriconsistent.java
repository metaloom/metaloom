...
public class JooqGinTrgmTriconsistent extends AbstractRoutine<String> {
     ...
     */
    public JooqGinTrgmTriconsistent() {
        super("gin_trgm_triconsistent", JooqPublic.PUBLIC, SQLDataType.CHAR);

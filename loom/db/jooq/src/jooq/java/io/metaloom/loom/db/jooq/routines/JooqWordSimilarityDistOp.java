...
public class JooqWordSimilarityDistOp extends AbstractRoutine<Float> {
     ...
     */
    public JooqWordSimilarityDistOp() {
        super("word_similarity_dist_op", JooqPublic.PUBLIC, SQLDataType.REAL);

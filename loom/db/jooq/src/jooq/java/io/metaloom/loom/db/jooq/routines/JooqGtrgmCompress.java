...
public class JooqGtrgmCompress extends AbstractRoutine<Object> {
     ...
     */
    public JooqGtrgmCompress() {
        super("gtrgm_compress", JooqPublic.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));

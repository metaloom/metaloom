...
public class JooqGtrgmPenalty extends AbstractRoutine<Object> {
     ...
     */
    public JooqGtrgmPenalty() {
        super("gtrgm_penalty", JooqPublic.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));

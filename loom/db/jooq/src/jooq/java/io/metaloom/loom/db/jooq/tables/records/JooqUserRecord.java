...
public class JooqUserRecord extends UpdatableRecordImpl<JooqUserRecord> implements Record15<UUID, String, String, String, String, Boolean, Boolean, Boolean, String, JsonObject, LocalDateTime, UUID, LocalDateTime, UUID, UUID> {
    ...
    /**
     * Setter for <code>public.user.avatar_attachment_uuid</code>. The account's
    ...
    /**
     * Getter for <code>public.user.avatar_attachment_uuid</code>. The account's
     * avatar picture. At most one exists per user, enforced by
     * idx_attachment_user_avatar_unique.
     */
    ...
    @Override
    public Row15<UUID, String, String, String, String, Boolean, Boolean, Boolean, String, JsonObject, LocalDateTime, UUID, LocalDateTime, UUID, UUID> fieldsRow() {
        return (Row15) super.fieldsRow();
    }

    @Override
    public Row15<UUID, String, String, String, String, Boolean, Boolean, Boolean, String, JsonObject, LocalDateTime, UUID, LocalDateTime, UUID, UUID> valuesRow() {
    ...
    public Field<UUID> field15() {
        return JooqUser.USER.AVATAR_ATTACHMENT_UUID;
    }
    ...
    @Override
    public JooqUserRecord value15(UUID value) {
        setAvatarAttachmentUuid(value);
        return this;
    }

    @Override
    public JooqUserRecord values(UUID value1, String value2, String value3, String value4, String value5, Boolean value6, Boolean value7, Boolean value8, String value9, JsonObject value10, LocalDateTime value11, UUID value12, LocalDateTime value13, UUID value14, UUID value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JooqUserRecord(UUID uuid, String username, String firstname, String lastname, String email, Boolean enabled, Boolean deleted, Boolean sso, String passwordHash, JsonObject meta, LocalDateTime created, UUID creatorUuid, LocalDateTime edited, UUID editorUuid, UUID avatarAttachmentUuid) {
        super(JooqUser.USER);

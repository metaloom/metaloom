...
public class Indexes {
    ...
    public static final Index IDX_ATTACHMENT_CHAT_UUID = Internal.createIndex(DSL.name("idx_attachment_chat_uuid"), JooqAttachment.ATTACHMENT, new OrderField[] { JooqAttachment.ATTACHMENT.CHAT_UUID }, false);
    ...
    public static final Index IDX_SEARCH_DOCUMENT_ASSET_TIME = Internal.createIndex(DSL.name("idx_search_document_asset_time"), JooqSearchDocument.SEARCH_DOCUMENT, new OrderField[] { JooqSearchDocument.SEARCH_DOCUMENT.ASSET_UUID, JooqSearchDocument.SEARCH_DOCUMENT.TIME_FROM }, false);

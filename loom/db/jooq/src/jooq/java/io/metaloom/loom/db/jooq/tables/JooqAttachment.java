...
public class JooqAttachment extends TableImpl<JooqAttachmentRecord> {
    ...
    /**
     * The column <code>public.attachment.creator_uuid</code>. NULL when written
     * by a Cortex worker rather than a user (see cortex_instance)
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> CREATOR_UUID = createField(DSL.name("creator_uuid"), SQLDataType.UUID, this, "NULL when written by a Cortex worker rather than a user (see cortex_instance)");
    ...
    /**
     * The column <code>public.attachment.editor_uuid</code>. NULL when written
     * by a Cortex worker rather than a user (see cortex_instance)
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> EDITOR_UUID = createField(DSL.name("editor_uuid"), SQLDataType.UUID, this, "NULL when written by a Cortex worker rather than a user (see cortex_instance)");

    /**
     * The column <code>public.attachment.node_kind</code>. Producing node kind,
     * e.g. thumbnail. NULL for user-uploaded attachments.
     */
    public final TableField<JooqAttachmentRecord, String> NODE_KIND = createField(DSL.name("node_kind"), SQLDataType.VARCHAR, this, "Producing node kind, e.g. thumbnail. NULL for user-uploaded attachments.");

    /**
     * The column <code>public.attachment.node_id</code>.
     */
    public final TableField<JooqAttachmentRecord, String> NODE_ID = createField(DSL.name("node_id"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.attachment.producer_version</code>.
     * Model/algorithm version of the producing node
     */
    public final TableField<JooqAttachmentRecord, String> PRODUCER_VERSION = createField(DSL.name("producer_version"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("''::character varying", SQLDataType.VARCHAR)), this, "Model/algorithm version of the producing node");

    /**
     * The column <code>public.attachment.variant</code>. Sub-division within
     * (asset, type, node_kind): sheet-1, t=00:10, ...
     */
    public final TableField<JooqAttachmentRecord, String> VARIANT = createField(DSL.name("variant"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("''::character varying", SQLDataType.VARCHAR)), this, "Sub-division within (asset, type, node_kind): sheet-1, t=00:10, ...");

    /**
     * The column <code>public.attachment.run_uuid</code>. Pipeline run that
     * produced this binary, when it was node-produced
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> RUN_UUID = createField(DSL.name("run_uuid"), SQLDataType.UUID, this, "Pipeline run that produced this binary, when it was node-produced");

    /**
     * The column <code>public.attachment.task_uuid</code>.
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> TASK_UUID = createField(DSL.name("task_uuid"), SQLDataType.UUID, this, "");

    /**
     * The column <code>public.attachment.detection_uuid</code>. The detection
     * this binary depicts, for a FACE_CROP. NULL for every other attachment
     * type.
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> DETECTION_UUID = createField(DSL.name("detection_uuid"), SQLDataType.UUID, this, "The detection this binary depicts, for a FACE_CROP. NULL for every other attachment type.");

    /**
     * The column <code>public.attachment.person_uuid</code>. Person that owns
    ...
    /**
     * The column <code>public.attachment.chat_uuid</code>. Chat that owns this
     * dropped file. Conversational rather than catalogued: it is not an asset
     * and it dies with the chat.
     */
    public final TableField<JooqAttachmentRecord, java.util.UUID> CHAT_UUID = createField(DSL.name("chat_uuid"), SQLDataType.UUID, this, "Chat that owns this dropped file. Conversational rather than catalogued: it is not an asset and it dies with the chat.");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ATTACHMENT_ASSET_VARIANT_KEY, Indexes.ATTACHMENT_DETECTION_VARIANT_KEY, Indexes.ATTACHMENT_UUID_IDX, Indexes.IDX_ATTACHMENT_ASSET_UUID, Indexes.IDX_ATTACHMENT_CHAT_UUID, Indexes.IDX_ATTACHMENT_DETECTION_UUID, Indexes.IDX_ATTACHMENT_PERSON_UUID, Indexes.IDX_ATTACHMENT_USER_AVATAR_UNIQUE, Indexes.IDX_ATTACHMENT_USER_UUID);
    }
    ...
    public JooqAsset asset() {
        if (_asset == null)
            _asset = new JooqAsset(this, Keys.ATTACHMENT__ATTACHMENT_ASSET_UUID_FKEY);
    ...
    public JooqPipelineRun pipelineRun() {
        if (_pipelineRun == null)
            _pipelineRun = new JooqPipelineRun(this, Keys.ATTACHMENT__ATTACHMENT_RUN_UUID_FKEY);
    ...
    public JooqPipelineNodeTask pipelineNodeTask() {
        if (_pipelineNodeTask == null)
            _pipelineNodeTask = new JooqPipelineNodeTask(this, Keys.ATTACHMENT__ATTACHMENT_TASK_UUID_FKEY);
    ...
    public JooqDetection detection() {
        if (_detection == null)
            _detection = new JooqDetection(this, Keys.ATTACHMENT__ATTACHMENT_DETECTION_UUID_FKEY);
    ...
    public JooqPerson person() {
        if (_person == null)
            _person = new JooqPerson(this, Keys.ATTACHMENT__ATTACHMENT_PERSON_UUID_FKEY);
    ...
    public JooqChat chat() {
        if (_chat == null)
            _chat = new JooqChat(this, Keys.ATTACHMENT__ATTACHMENT_CHAT_UUID_FKEY);
    ...
    @Override
    public Row22<java.util.UUID, String, java.util.UUID, java.util.UUID, String, JooqAttachmentType, String, JsonObject, LocalDateTime, java.util.UUID, LocalDateTime, java.util.UUID, String, String, String, String, java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID, java.util.UUID> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function22<? super java.util.UUID, ? super String, ? super java.util.UUID, ? super java.util.UUID, ? super String, ? super JooqAttachmentType, ? super String, ? super JsonObject, ? super LocalDateTime, ? super java.util.UUID, ? super LocalDateTime, ? super java.util.UUID, ? super String, ? super String, ? super String, ? super String, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function22<? super java.util.UUID, ? super String, ? super java.util.UUID, ? super java.util.UUID, ? super String, ? super JooqAttachmentType, ? super String, ? super JsonObject, ? super LocalDateTime, ? super java.util.UUID, ? super LocalDateTime, ? super java.util.UUID, ? super String, ? super String, ? super String, ? super String, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? super java.util.UUID, ? extends U> from) {

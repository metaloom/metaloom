...
public class JooqSearchDocumentRefreshPerson extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.search_document_refresh_person.p_uuid</code>.
     */
     ...
     */
    public JooqSearchDocumentRefreshPerson() {
        super("search_document_refresh_person", JooqPublic.PUBLIC);

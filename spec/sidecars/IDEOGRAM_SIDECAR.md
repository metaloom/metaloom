...
> Node catalog: [../features/pipeline-nodes/NODES.md](../features/nodes/NODES.md).
...
spec/features/nodes/image-generation/NODE_IMAGEGEN.md §3, which shows `{status, model, device, remix_mode}`. Minor doc drift only.
...
[NODE_IMAGEGEN.md](../features/nodes/image-generation/NODE_IMAGEGEN.md) §5.
...
- [ ] **Commercial-safe default model undecided** (see spec/features/nodes/image-generation/NODE_IMAGEGEN.md §4); `website/.../docs/legal/model-licenses/` is stale
...
| Node options, ports, persistence, node tests | [NODE_IMAGEGEN.md](../features/nodes/image-generation/NODE_IMAGEGEN.md) |
| The port/content-type model for `artifact/image` | [../features/nodes/NODE_DATA_TYPES.md](../features/nodes/NODE_DATA_TYPES.md) |
| Why the generated bytes never reach Loom | [../features/rest/REST_CORTEX_METADATA_BINARY_HANDLING_PLAN.md](../concept/REST_CORTEX_METADATA_BINARY_HANDLING_PLAN.md) |

...
| **"What else is like this asset?"** — the asset relationship graph index over tags, collections, remixes and people | [features/graph/ASSET_GRAPH.md](features/graph/ASSET_GRAPH.md) — prototype, **disabled by default**; §8 records why it is not adopted (2.4x over tuned SQL, not 657x over naive SQL) |

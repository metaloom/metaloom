...
public class AssetBinaryFilesystemInfo {
	...
	public AssetBinaryFilesystemInfo setPath(String path) {
		this.path = path;
		return this;
	}
	...
	public AssetBinaryFilesystemInfo setFilekey(FileKey filekey) {
	...
	public AssetBinaryFilesystemInfo setLastSeen(Instant lastSeen) {

...
/**
 * POJO to map the properties from the loom.build.properties resource file. The file is updated via maven property filtering during build/release time.
 */
public class BuildInfo {
	...
	public BuildInfo(Properties buildProperties) {
		this(buildProperties.getProperty("loom.version"), buildProperties.getProperty("loom.build.timestamp"));
	}
	...
	public String getVersion() {
		String overrideVersion = System.getProperty("loom.internal.version");

...
public class Assertions extends org.assertj.core.api.Assertions {
	...
	public static AssetBinaryModelAssert assertThat(AssetBinaryResponse model) {
		return new AssetBinaryModelAssert(model);
	}
	...
	public static AssetPoolModelAssert assertThat(AssetPoolResponse model) {
		return new AssetPoolModelAssert(model);
	}
	...
	public static ShareModelAssert assertThat(ShareResponse model) {
		return new ShareModelAssert(model);
	}

	public static RemixModelAssert assertThat(RemixResponse model) {
		return new RemixModelAssert(model);
	}
	...
	public static PersonModelAssert assertThat(PersonResponse model) {
		return new PersonModelAssert(model);
	}

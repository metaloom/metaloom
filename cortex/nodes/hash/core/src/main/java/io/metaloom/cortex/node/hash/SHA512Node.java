...
@NodeSpec(nodeId = "sha512", name = "SHA-512 Hash", icon = "fingerprint", category = NodeCategory.ANALYSIS,
	description = "Compute the SHA-512 hash of the media file.", defaultConcurrency = 4)
public class SHA512Node extends AbstractMediaNode<HashNodeOptions> {
	...
	@PortDoc(label = "SHA-512", description = "Lowercase hex SHA-512 digest over the whole file")

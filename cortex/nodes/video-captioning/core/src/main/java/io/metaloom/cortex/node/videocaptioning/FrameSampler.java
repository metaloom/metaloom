...
public final class FrameSampler {
	...
	/**
	 * Sample {@code count} frames evenly across the frame range {@code [fromFrame, toFrame]} (inclusive). Used by the scene-first variant to grab
	 * representative frames from a single detected scene.
	 */
